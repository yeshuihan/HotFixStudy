...
class DefaultMethodRuntimePrintInject: MethodInjectInterface {
    var temp1:Int = 0
...
//            ASTORE 5
        ...
        adapter.getStatic(Type.getType("Ljava/lang/System;"), "out", Type.getType("Ljava/io/PrintStream;"))
        adapter.loadLocal(temp3)
        adapter.invokeVirtual(Type.getType("Ljava/io/PrintStream;"), Method("println", "(Ljava/lang/Object;)V"))
